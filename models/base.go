...
type BaseModel struct {
	Id        uint64 `gorm:"column:id;primary_key;AUTO_INCREMENT;column:id" json:"id"`
	CreatedAt XTime  `gorm:"column:created_at" json:"created_at"`
	UpdatedAt XTime  `gorm:"column:updated_at" json:"updated_at"`
}
